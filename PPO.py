...
class PPO:
	...
	def _init_hyperparameters(self, hyperparameters):
		...
		self.gamma =                                # Discount factor to be applied when calculating Rewards-To-Go
		self.clip =                                  # Recommended 0.2, helps define the threshold to clip the ratio during SGA
